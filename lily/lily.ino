...
RookieBot lily;  //This creates an instance of the RookieBot, 
...
//drive forward
//stop within 10 inches of object "read the sonar"

while (lily.sonar() > 18)
{
lily.go(75);
Serial.print(lily.sonar());
}

lily.stop();
delay(200);

lily.turnRight(100,940);
