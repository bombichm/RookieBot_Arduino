...
RookieBot Skyler;  //This creates an instance of the RookieBot, 
...
//stop within 20 inches of object"read the sonar"
while (Skyler.sonar()>20)
{
  Skyler.go (150);
}
